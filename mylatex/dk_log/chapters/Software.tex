...
\section{Prometheus}
Prometheus数据库是一款时间数据库，可以用来采集操作系统或者数据库资源使用情况，通过granafa将数据展示出来
...
\subsubsection{Grafana监控windows系统资源}
\subsubsection{Grafana监控linux系统资源}
\subsubsection{Grafana监控mysql数据库}
需要而外安装mysql_exporter服务将mysql数据暴露给
